...
public:
	...
	void initialize_cbv_srv_uav(ID3D12Device* device, DXGI_FORMAT const format, graphics* const heaps_owner);
	void initialize_dsv(ID3D12Device* device, DXGI_FORMAT const format, graphics* const heaps_owner);
	void initialize_rtv(ID3D12Device* device, graphics* const heaps_owner, DXGI_FORMAT const format);
	void initialize_rtv(ID3D12Device* device, graphics* const heaps_owner, IDXGISwapChain3* swap_chain, int const buffer_id);
